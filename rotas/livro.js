...
const { getLivros, getLivro, postLivro, patchLivro, deletaLivro } = require("../controladores/livro")       //Importação das funções a partir da camada de servicos, que farão operações no sistema
